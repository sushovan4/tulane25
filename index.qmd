...
- <green>Geometric reconstruction</green> entails constructing <red>$\hat{\mathcal G}\subset\mathbb R^N$</red> from samples so that 
    - $\hat{\mathcal G}\simeq \mathcal G$
    - <green>$d_H(\hat{\mathcal G}, \mathcal S)$ is small</green>.
...
![](shadow-1.png){width="65%" fig-align="center"}
...
![](shadow-2.png){width="65%" fig-align="center"}
