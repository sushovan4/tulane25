...
## <green>$\varepsilon$</green>-path Metric {.smaller}
...
:::{.callout}
## 
For a dense enough sample $\mathcal S$ of $\mathcal G$, $d^\varepsilon_S$ is <green>quasi-isometric</green> to the <green>length metric</green> on $\mathcal G$.
:::
