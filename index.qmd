...
![<gray>GPS locations around Berlin</gray>](berlin.jpg)

<red>Q</red>: How to draw the map of the city from a <red>noisy</red> point-cloud of <green>GPS locations</green>?

## 
![<gray>Source: mapconstruction.org</gray>](mahmuda.jpg)

<green>A</green>: A possible reconstruction of Berlin [@10.5555/2878633]
...
- <green>**Goal**</green>: Infer the topology of $\mathcal G$ from $\mathcal S$.
    ...
    - <green>construct</green> a topological space $\hat{\mathcal G}$ (e.g. Vietoris--Rips) from $\mathcal S$ so that
